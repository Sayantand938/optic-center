...
export const menuItems: MenuItem[] = [
    ...
    { id: 3, label: 'Pending Order', screen: 'Pending Order', action: () => alert('Pending Order screen coming soon') },
    { id: 4, label: 'Pending Payment', screen: 'Pending Payment', action: () => alert('Pending Payment screen coming soon') },
